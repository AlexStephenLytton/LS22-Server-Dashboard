...
function game($icon,$title)
{
    ...
    echo "<tr><td>Server</td><td>" . $xml["version"] . "</td></tr>";
    echo "<tr><td>Maximum Players</td><td>" . $xml->Slots["capacity"] . "</td></tr>";
    echo "<tr><td>Name</td><td>" . $xml["name"] . "</td></tr>";
    echo "<tr><td>Map</td><td>" . $xml["mapName"] . "</td></tr>";
    echo "<tr><td>DayTime</td><td>" . $xml["dayTime"] . "</td></tr>";
    echo "<tr><td>Money</td><td>" . $xml2->statistics->money[0] . " €</td></tr>";
    echo '</table>';
    ...
    echo "<tr><td>Days per Period</td><td>" . $xml2->settings->plannedDaysPerPeriod[0] . "</td></tr>";
